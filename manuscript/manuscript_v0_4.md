...
Table 4 summarizes the claim ladder that bounds these statements.
...
Figure 2 summarizes the grouped validation design used throughout the benchmark.
...
Figure 1 summarizes the linked data-product architecture, and Table 1 lists the audited cohort facts.
...
Figure 2 shows how cell replicates are grouped by parameter-set condition before split evaluation.
...
Figure 3 summarizes the capacity ladder on the C-rate holdout, and Table 3 summarizes split difficulty.
...
Figure 5 summarizes the mixed stress-feature decision, and Table 5 records the negative results.
...
Figure 6 summarizes PULSE target coverage, while Figure 7 shows scalar resistance baseline performance.
...
Figure 8 shows the diagnostic residual association, and Figure 9 compares prior PULSE against the strongest supplied non-PULSE baselines.
...
Table 5 consolidates the negative results that constrain the paper's claims.
