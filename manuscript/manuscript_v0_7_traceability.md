# Manuscript v0.7 Traceability

This sidecar maps the reader-facing v0.7 manuscript to the v2 claim ledger and
...
| Temporal Order, Knee Labels, and Threshold Events | C16, C17, C18, C28, C38 | Figure 13, Table 6 | `docs/experiments/2026-05-23_temporal_history_value_gate.md`; `docs/experiments/2026-05-23_knee_threshold_label_forensics.md`; `docs/experiments/2026-05-27_minimal_sequence_reopening_gate.md`; `docs/experiments/2026-05-28_neural_sequence_architecture_gate.md` | Sequence readiness, neural sequence readiness, CBAT readiness, and detector-knee prediction remain blocked; threshold labels are the stronger label family. | Do not claim sequence, neural, CBAT, or detector-knee prediction readiness. |
...
| Release Package and Reproducibility | C11, C12, C19, C38 | Figure 14, Table 8 | `reports/synthesis/release_candidate_check.md`; `reports/synthesis/benchmark_v0_1_rc2_handoff_check.md`; `docs/POST_RC2_MAIN_STATUS.md`; `reports/synthesis/benchmark_task_registry_check_v2.md`; GitHub release `benchmark-v0.1-rc2` | The rc2 package is the published anchor; latest `main` adds post-rc2 negative Milestone 9 evidence and task registry v2. | Do not imply release packaging adds new science or CBAT progress. |
| Discussion and Limitations | C02, C07-C11, C14-C17, C28, C38 | Table 5, Table 6 | `reports/synthesis/blocked_claims_v2.md`; `reports/synthesis/next_branch_decision.md`; `reports/baselines/neural_sequence_gate/neural_sequence_claim_readiness.md` | Negative and blocked results are part of the benchmark contribution, including the post-rc2 negative neural-sequence architecture gate. | Do not reopen CBAT, sequence, neural, policy, DRT, embedding, detector-knee, or causal branches without a new gate. |

## Reviewer-Risk Link

Likely reviewer objections are tracked in
`reports/synthesis/reviewer_risk_register_v2.md`, with response language in
`manuscript/reviewer_response_prep_v2.md`.

## Reader-Facing Prose Guardrails

The v0.7 manuscript body should remain reader-facing. Claim IDs, source maps,
...
risk-score calibration, global interval reliability, sequence or neural
readiness, detector-knee prediction, policy ranking, same-cell counterfactuals,
and broad multimodal benefit.
