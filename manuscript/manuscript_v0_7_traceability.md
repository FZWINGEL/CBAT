...
| Release Package and Reproducibility | C11, C12, C19, C38 | Figure 14, Table 8 | `reports/synthesis/release_candidate_check.md`; `reports/synthesis/benchmark_v0_1_rc2_handoff_check.md`; `docs/POST_RC2_MAIN_STATUS.md`; `reports/synthesis/benchmark_task_registry_check_v2.md`; GitHub release `benchmark-v0.2-rc1` | The v0.2-rc1 package is the current post-Milestone-9 reviewer checkpoint; rc2 remains the earlier handoff archive. | Do not imply release packaging adds new science or CBAT progress. |
