...
|---|---|---|
| Raw HGB quantiles calibrated | `not_supported` | Q0_hgb_quantile_raw: evaluated 24 rows; min coverage 0.00226244; mean coverage 0.701398; C-rate acceptable=False. |
