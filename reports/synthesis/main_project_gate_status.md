...
then audits the target boundary and shows the repair does not transfer to
`capacity_Ah_k1`, so the C-rate repair claim remains delta-only. No milestone
