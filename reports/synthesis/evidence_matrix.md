...
| LOG_AGE scalar features | partially_supported | `F3_state_nominal -> F4_state_log_age_scalar` is mixed: mean gain 0.000085, positive rows 10/20. | Current scalar summaries help nonlinear models in some views but do not justify broad exposure claims. |
