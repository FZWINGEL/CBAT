...
5.6 locks a narrow positive adaptive stressor-robust diagnostic, and
Milestone 5.7 keeps F8 stress-feature attribution diagnostic-only because the
incremental F8 comparison fails outside-split guardrails. Additional robustness
tuning would need a fresh predeclared question to avoid claim chasing.
