...
| Policy ranking | Milestone 7.2 shows observed matched contrast support and sign stability, but there is still no ranking model gate, no calibrated risk, no intervention test, and no causal evidence. | `reports/analysis/policy/policy_claim_readiness.md`; `reports/baselines/threshold_warning_calibration/threshold_warning_calibration_claim_readiness.md` |
