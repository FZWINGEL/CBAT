...
| Policy ranking | Milestone 7.2 shows observed matched contrast support and sign stability. Milestone 7.3 adds partial existing-prediction contrast-ordering signal, but HGB K2 fails the strict prior-slope bootstrap reference gate and there is still no calibrated risk, intervention test, or causal evidence. | `reports/analysis/policy/policy_claim_readiness.md`; `reports/analysis/policy/policy_ranking_claim_readiness.md`; `reports/baselines/threshold_warning_calibration/threshold_warning_calibration_claim_readiness.md` |
