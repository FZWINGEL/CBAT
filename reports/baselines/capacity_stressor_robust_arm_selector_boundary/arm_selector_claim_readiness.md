...
| Selected arm counts | `diagnostic` | `D0_R0_F4_reference:23; D2_adaptive_R2_F4_conservative:1`. |
...
|---|---:|---:|
| `capacity_Ah_k1` | `0` | `True` |
| `delta_capacity_Ah` | `0` | `True` |

Selection rows evaluated: `48`.
Comparison rows evaluated: `10`.
