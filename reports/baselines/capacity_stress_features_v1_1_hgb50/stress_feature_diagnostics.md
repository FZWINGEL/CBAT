...
Generated at UTC: `2026-05-22T22:17:24.883979+00:00`

## Success Criteria

| Target | Split | Stress feature group | Stress MAE | F4 MAE | Gain vs F4 | Success |
|---|---|---|---:|---:|---:|---|
| `capacity_Ah_k1` | `c_rate_holdout_fold` | `F5_log_age_histograms` | 0.120605 | 0.125186 | 0.00458108 | True |
...
|---|---|---|---|
| Stress features improve C-rate holdout | not_supported | C-rate gains vs F4: 0.00458108, -0.00138302; condition rows: 24 | Do not claim stress-feature improvement |
