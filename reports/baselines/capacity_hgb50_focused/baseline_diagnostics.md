...
Generated at UTC: `2026-05-24T15:12:15.085793+00:00`
...
|---|---|---|---|---:|---|---:|---:|
| `delta_capacity_Ah` | `condition_fold` | `L2_hist_gradient_boosting` | `F4_state_log_age_scalar` | 0.0446449 | `reference_missing` | reference_missing | 20 |
...
| `capacity_Ah_k1` | `condition_fold` | `L2_hist_gradient_boosting` | `F4_state_log_age_scalar` | 0.0539267 | `reference_missing` | reference_missing | 23 |
| `capacity_Ah_k1` | `profile_holdout_fold` | `L2_hist_gradient_boosting` | `F1_state_time` | 0.0621921 | `reference_missing` | reference_missing | 70 |
| `delta_capacity_Ah` | `profile_holdout_fold` | `L3_quantile_hist_gradient_boosting` | `F1_state_time` | 0.0650827 | `reference_missing` | reference_missing | 67 |
| `delta_capacity_Ah` | `voltage_window_holdout_fold` | `L3_quantile_hist_gradient_boosting` | `F1_state_time` | 0.068512 | `reference_missing` | reference_missing | 32 |
| `capacity_Ah_k1` | `temperature_holdout_fold` | `L2_hist_gradient_boosting` | `F4_state_log_age_scalar` | 0.0692939 | `reference_missing` | reference_missing | 23 |
...
| `capacity_Ah_k1` | `c_rate_holdout_fold` | `L2_hist_gradient_boosting` | `F4_state_log_age_scalar` | 0.125186 | `reference_missing` | reference_missing | 36 |
...
| `capacity_Ah_k1` | `L2_hist_gradient_boosting` | `F4_state_log_age_scalar` | 0.125186 | `reference_missing` | reference_missing |
