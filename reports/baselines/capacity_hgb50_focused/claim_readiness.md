...
| Nominal protocol features help | Supported | `F2_state_exposure -> F3_state_nominal` mean gain 0.00843869 across 20 primary rows. | Keep nominal protocol features. |
