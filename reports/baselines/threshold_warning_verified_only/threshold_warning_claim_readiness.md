...
| Warning baseline feasibility | `partially_supported` | Best model mean Brier gain versus event-rate prior is `0.0392323`. |
| Beats distance-to-threshold baseline | `partially_supported` | Best HGB mean Brier gain versus best proximity baseline is `0.0352097`. |
