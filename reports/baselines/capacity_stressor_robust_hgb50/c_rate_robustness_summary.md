...
| `capacity_Ah_k1` | `R3_condition_bagged_hgb` | `F4_state_log_age_scalar` | `0.137942` | `0.287713` |
| `capacity_Ah_k1` | `R3_condition_bagged_hgb` | `F8_timestamp_weighted_stress` | `0.142306` | `0.290238` |
...
| `delta_capacity_Ah` | `R3_condition_bagged_hgb` | `F8_timestamp_weighted_stress` | `0.104468` | `0.222414` |
| `delta_capacity_Ah` | `R3_condition_bagged_hgb` | `F4_state_log_age_scalar` | `0.119037` | `0.260058` |
