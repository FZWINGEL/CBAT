...
This release candidate is the reviewer-facing source archive for the
grouped-validation benchmark. It contains the validated benchmark code and
reports plus release-polish handoff documents. It does not include raw data,
generated interim Parquets, processed prediction Parquets, or new scientific
claims beyond the v2 claim ledger.

`benchmark-v0.1-rc1` remains the validation checkpoint at `ff4c8c2`; rc2 exists
to include the handoff documents in the release source archive.
...
- rc1 and rc2 release notes
- tag-preparation docs
- GitHub release draft text
- benchmark release summary and handoff checks
...
- interim modality, interval, feature, target, and label Parquets under `data/interim/`
...
Before publishing `benchmark-v0.1-rc2`:

- `benchmark-v0.1-rc2` was verified to point to commit `e499b12`
- the GitHub release was verified as published and marked prerelease
- no raw, interim, processed, or prediction Parquets were added by release polish
